...
module.exports = {
    ...
    globalExports: {
        ...
        //如果允许，则 require('@definejs/object') === definejs.require('Object');
    ...
    //把 dependencies 合并到项目的 package.json 中去（如果存在）。
        ...
        if (File.exists(file)) {
            ...
            dependencies = Object.assign(dependencies, name$version);
            dependencies = $Object.sort(dependencies);
